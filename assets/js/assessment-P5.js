...
var assessment = {
  ...
  questionsList: [
    ...
    {questionHTML: '<h3>Define a function  <font color="red">isOdd(X)</font> that returns true if its argument <font color="red">X</font> is an odd number. You do not need an if/else for this problem.</h3>',
