...
var assessment = {
  ...
  questionsList: [
    {questionHTML: '<h3>Define a function named <font color="red">hypotenuse (a, b)</font> that calculates the length of the hypotenuse of a right triangle given the lengths of its two sides, <font color="red">a</font> and <font color="red">b</font>.</h3>',
